...
# build `v<version>`. 0.5.0a1: detection complete (REST) + WS streaming cache/runner + C1
# conservative sizing; streaming↔scanner integration (phase 3) and execution (phase 5) pending.
__version__ = "0.5.0a1"
